...
class Notification {
	...
	protected static $key = "notificationid";
	protected static $table="notification";
	protected static $db_fields = array('notificationid', 'userid', 'note', 'description', 'link', 'epoch');
	//no primary key
	public static $db_defaults = array('userid'=>0, 'note'=>' ', 'description'=>' ', 'link'=>'#', 'epoch'=>0);
